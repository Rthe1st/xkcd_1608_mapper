...
def add_arguments(parser):
    ...
    parser.add_argument(
        ...
        default=20,
        help="Default is 20, ~200 needed to read speech bubbles",
    )
...
def run(args):
    ...
    stitch_images.stitch_tiles_to_rows(
        X_MIN, X_MAX, y_min, y_max, args.reduced_image_size
    )
    stitch_images.stitch_rows_to_image(
        X_MIN, X_MAX, y_min, y_max, args.reduced_image_size
    )
